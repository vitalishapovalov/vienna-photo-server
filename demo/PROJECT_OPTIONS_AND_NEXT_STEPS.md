...
2. ДЕМО №2 Як виглядає застосунок, як працює менеджмент прінтера, як працює менеджмент темплейта (фрейма), інформація про статус сервера (коробку Raspberry Pi), де будуть лежати зроблені фото.
3. ДЕМО №3 Як виглядає мануальний процес зйому (він знадобиться для тестування, налаштування). Вибір темплейту (фрейму), вибір фільтру, підтвердження та відправка результату на друк. Де лежить фото.
...
Я оновив твій темплейт, скачати можна тут
Також, сам оновлений скріпт скачати можна тут
